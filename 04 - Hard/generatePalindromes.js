...
const generatePalindromes = (limit) => {
  const nums = [];
...
console.log(
  ...
  [
    985589, 986689, 987789, 988889, 989989, 990099, 991199, 992299, 993399,
    994499, 995599, 996699, 997799, 998899, 999999,
  ],
  'Example #3'
);
console.log(
  generatePalindromes(3443),
  [
